        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('create-footer')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="number" id="exampleInputuname35" placeholder="Write Your Number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputuname36" class="col-sm-3 control-label">Email<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="email" id="exampleInputuname36" placeholder="Write your Email">
                                </div>
                            </div>

                            <div class="form-group row m-b-0">
                                <div class="offset-sm-3 col-sm-9">
                                    <button type="submit" class="btn btn-success waves-effect waves-light text-white">Create new Footer</button>
                                </div>
                            </div>
                        </div>
                    </form>
