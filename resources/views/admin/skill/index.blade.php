        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('create-skill')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="experience" id="exampleInputEmail3" placeholder="experience">
                                </div>
                            </div>
