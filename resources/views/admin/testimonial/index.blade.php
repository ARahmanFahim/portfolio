        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('create-tastimonial')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="client_name" id="exampleInputuname3" placeholder="client Name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputuname34" class="col-sm-3 control-label"> Testimonial Designation<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="testimonial_designation" id="exampleInputuname34" placeholder="testimonial designation">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputuname35" class="col-sm-3 control-label">Testimonial Work Name<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="work_name" id="exampleInputuname35" placeholder="testimonial work name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputuname36" class="col-sm-3 control-label">Testimonial Delivary Date<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="delivery_date" id="exampleInputuname36" placeholder="testimonial delivary date">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row m-b-0">
                                <div class="offset-sm-3 col-sm-9">
                                    <button type="submit" class="btn btn-success waves-effect waves-light text-white">Create new Testimonial</button>
                                </div>
                            </div>
                        </div>
                    </form>
